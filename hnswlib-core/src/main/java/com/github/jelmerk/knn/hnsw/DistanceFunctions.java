...
public final class DistanceFunctions {
     ...
     * Calculates the cosine distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_COSINE_DISTANCE = new DistanceFunctions.FloatCosineDistance();

    /**
     * Calculates the inner product distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_INNER_PRODUCT = new DistanceFunctions.FloatInnerProduct();

    /**
     * Calculates the euclidean distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_EUCLIDEAN_DISTANCE = new DistanceFunctions.FloatEuclideanDistance();

    /**
     * Calculates the canberra distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_CANBERRA_DISTANCE = new DistanceFunctions.FloatCanberraDistance();

    /**
     * Calculates the bray curtis distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_BRAY_CURTIS_DISTANCE = new DistanceFunctions.FloatBrayCurtisDistance();

    /**
     * Calculates the correlation distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_CORRELATION_DISTANCE = new DistanceFunctions.FloatCorrelationDistance();

    /**
     * Calculates the manhattan distance.
     */
    public static final DistanceFunction<float[], Float> FLOAT_MANHATTAN_DISTANCE = new DistanceFunctions.FloatManhattanDistance();

    /**
     * Calculates the cosine distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_COSINE_DISTANCE = new DistanceFunctions.DoubleCosineDistance();

    /**
     * Calculates the inner product.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_INNER_PRODUCT = new DistanceFunctions.DoubleInnerProduct();

    /**
     * Calculates the euclidean distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_EUCLIDEAN_DISTANCE = new DistanceFunctions.DoubleEuclideanDistance();

    /**
     * Calculates the canberra distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_CANBERRA_DISTANCE = new DistanceFunctions.DoubleCanberraDistance();

    /**
     * Calculates the bray curtis distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_BRAY_CURTIS_DISTANCE = new DistanceFunctions.DoubleBrayCurtisDistance();

    /**
     * Calculates the correlation distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_CORRELATION_DISTANCE = new DistanceFunctions.DoubleCorrelationDistance();

    /**
     * Calculates the manhattan distance.
     */
    public static final DistanceFunction<double[], Double> DOUBLE_MANHATTAN_DISTANCE = new DistanceFunctions.DoubleManhattanDistance();

    /**
     * Calculates the inner product.
     */
    public static final DistanceFunction<SparseVector<float[]>, Float> FLOAT_SPARSE_VECTOR_INNER_PRODUCT =
            new DistanceFunctions.FloatSparseVectorInnerProduct();

    /**
     * Calculates the inner product.
     */
    public static final DistanceFunction<SparseVector<double[]>, Double> DOUBLE_SPARSE_VECTOR_INNER_PRODUCT =
            new DistanceFunctions.DoubleSparseVectorInnerProduct();
}
